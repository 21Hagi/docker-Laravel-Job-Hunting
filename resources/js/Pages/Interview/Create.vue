                            ...
                            <div>
                                <div class="p-2 w-2/3 mx-auto">
                                    ...
                                    <div class="p-2 w-full mt-4 flex justify-around">
                                        <Link :href="route('interview.setting')" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-xm"><i class="fa-solid fa-arrow-rotate-left pr-1"></i>戻る</Link>
